    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 color_cube = UNITY_SAMPLE_TEXCUBE(unity_SpecCube0, reflect_dir);
                color_cube = pow(color_cube, 2.2);
                //color_cube = fixed4(DecodeHDR(color_cube, _CubeMap_HDR), 1.0);
                color_cube = fixed4(ACESToneMapping(color_cube.rgb, _Lum), 1.0);
